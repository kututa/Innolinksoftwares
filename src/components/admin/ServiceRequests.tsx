              ...
              <tr key={request.id} className="hover:bg-gray-50">
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-10 w-10">
                      <img
                        ...
                        src={`https://ui-avatars.com/api/?name=${request.client}&background=random`}
                        alt=""
                      />
                    </div>
                    <div className="ml-4">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex space-x-2">
                    <button className="p-1 hover:bg-blue-100 rounded" title="Message Client">
                    ...
                    <button className="p-1 hover:bg-yellow-100 rounded" title="Flag Request">
